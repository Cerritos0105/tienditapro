...
public class Gestion_Ventas extends javax.swing.JFrame {
    Fondo_Panel fondo = new Fondo_Panel();

    /**
     * Creates new form Gestion_Ventas
     */
    public Gestion_Ventas() {
        ...
        while(!lista.isEmpty()){
            ...
            nombre=lista.getFirst().getIdE();
            apellido=lista.getFirst().getFch();
            cargo=lista.getFirst().getTotal();
    ...
    private void initComponents() {
        ...
        listaPro.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id Venta", "Id Empleado", "Fecha", "Precio"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Gestion_Ventas().setVisible(true);
            }
        });
    }
